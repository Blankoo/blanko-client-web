...
export function fetchTasks(projectID, filter) {
...
export function updateProject(projectId, updateObject) {
    return (dispatch, getState) => {
        ...
        return http.put(`${config.apiUrl}/projects/${projectId}`, updateObject)
            .then((resolved) => {
                dispatch({
...
export function updateTask(bodyToUpdate, taskId) {
    return (dispatch) => {
        return http.put(`${config.apiUrl}/tasks/update/${taskId}`, bodyToUpdate)
            .then((resolved) => {
